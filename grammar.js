...
module.exports = grammar({
  ...
  precedences: ($) => [
    ...
    //   $._expression,
    // ],
    // [$.command_expr, $.command_argument, $._primary_expr],
  ],
  rules: {
    lumesh: ($) =>
    ...
    match_arm: ($) =>
      seq(
        field('pattern', choice('_', commaSep1($.literal))),
        '=>',
